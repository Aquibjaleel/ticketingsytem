...
def edit_ticket(ticket_id):
    ...
    if is_ticket_closed(ticket.current_status.status):
        return redirect(url_for('flicket_bp.ticket_view_detail', ticket_id=ticket.id))
...
def edit_post(post_id):
    ...
    if is_ticket_closed(post.ticket.current_status.status):
        return redirect(url_for('flicket_bp.ticket_view_detail', ticket_id=post.ticket.id))
    ...
    if not_authorised:
        ...
        return redirect(url_for('flicket_bp.ticket_view_detail', ticket_id=post.ticket_id))
